...
//		vivek::Filterbank::copy_header(fanbeams.begin()->second,stitched_filterbank,verbose);
//
...
//
//		std::string candidate_file_name = get_candidate_file_name(out_dir,point_idx);
//		stitched_filterbank->add_to_header(CANDIDATE_FILENAME_KEY,STRING,candidate_file_name);
//		stitched_filterbank->add_to_header(OUT_DIR_KEY,STRING,out_dir);
//
...
//		stitched_filterbank->remove_header_param(CANDIDATE_FILENAME_KEY);
//		stitched_filterbank->remove_header_param(OUT_DIR_KEY);
//
